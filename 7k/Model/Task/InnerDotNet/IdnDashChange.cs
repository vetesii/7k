...
{
    class IdnDashChange : AbstractTask
    {
        ...
        public IdnDashChange (IdnDashChange original)
	    {
            // ennél speciel nem kell ilyen konstruktor
            // file-ból való felolvasáskor sem kell!

            // paraméter nélküli konstruktor hívása


            // amennyire lehet lemásolja a beállításait
	    }

        /*
        public TaskOfChangeDash() 
        {
